...
public class DBConstants {
    ...
    public static final String GET_ALL_TICKET = "select t.PARKING_NUMBER, t.OUT_TIME from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? order by t.PARKING_NUMBER";
}
